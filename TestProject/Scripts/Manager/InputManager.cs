...
public class InputManager : SingletonMonoBehaviour<InputManager>
{
	...
	void Update () {
		...
		{
		case InputManager.TouchState.None: TouchStateNone (); break;
		case InputManager.TouchState.Move: TouchStateMove (); break;
		case InputManager.TouchState.Pinch: TouchStatePinch (); break;
		}
	}
	...
	void TouchStatePinch () {
		...
		//	ピンチスケール
		float scale = (Input.GetTouch (0).position - Input.GetTouch (1).position).Length ();
